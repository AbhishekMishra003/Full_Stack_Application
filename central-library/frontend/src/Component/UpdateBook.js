...
class UpdateBook extends Component {
    ...
    componentDidMount(){
        UserDetailsService.getBookById(this.state.id).then((res) =>{
            let book = res.data;
            console.log("BookDetails1=>" + JSON.stringify(book));
            this.setState({
                bookId: book.bookId,
                title: book.title,
                ...
                numberOfShelf: book.numberOfShelf,
                nameOfLibrary: book.nameOfLibrary,
